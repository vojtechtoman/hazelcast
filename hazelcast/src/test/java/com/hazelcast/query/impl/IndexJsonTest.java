...
public class IndexJsonTest {
    ...
    public void testJsonIndex() {
        ...
        Index numberIndex = is.addOrGetIndex("age", false, false);
        Index boolIndex = is.addOrGetIndex("active", false, false);
        Index stringIndex = is.addOrGetIndex("name", false, false);
